...
public class WordCounterExploration3 {
	...
	public static void main( String[] args ) {
		// Exploration3
			...
			WordCounterExploration3 wcReddit = new WordCounterExploration3("HashMap");
			ArrayList<String> wordsReddit = wcReddit.readWords(filenameReddit);
		

			for (int i=0 ; i<5; ++i){	
				wcReddit.buildMap(wordsReddit);
				System.out.println("Trial "+ i + ": Max Depth of HashMap Reddit: " + wcReddit.getMaxDepth());
			}
			...
			WordCounterExploration3 wcShakespeare = new WordCounterExploration3("HashMap");
			ArrayList<String> wordsShakespeare = wcShakespeare.readWords(filenameShakespeare);
			// wcShakespeare.buildMap(wordsShakespeare);
		
			for (int i=0 ; i<5; ++i){	
				wcShakespeare.buildMap(wordsShakespeare);
				System.out.println("Trial "+ i + ": Max Depth of HashMap Shakespeare: " +  wcShakespeare.getMaxDepth());
			}
			...
			// BSTMap Reddit
			String filenameReddit2 = "CLEANED_reddit_comments_2015.txt";
			WordCounterExploration3 wcReddit2 = new WordCounterExploration3("BST");
			ArrayList<String> wordsReddit2 = wcReddit2.readWords(filenameReddit2);


			for (int i=0 ; i<5; ++i){	
				wcReddit2.buildMap(wordsReddit2);
				System.out.println("Trial "+ i + ": Max Depth of BSTMap Reddit: " + + wcReddit2.getMaxDepth());
			}
			...
			// BSTMap Shakespeare
			String filenameShakespeare2 = "CLEANED_shakespeare.txt";
			WordCounterExploration3 wcShakespeare2 = new WordCounterExploration3("BST");
			ArrayList<String> wordsShakespeare2 = wcShakespeare2.readWords(filenameShakespeare2);
			// wcShakespeare.buildMap(wordsShakespeare);
		
			for (int i=0 ; i<5; ++i){	
				wcShakespeare2.buildMap(wordsShakespeare2);
				System.out.println("Trial "+ i + ": Max Depth of BSTMap Shakespeare: " + wcShakespeare2.getMaxDepth());
			}
	...
	public WordCounterExploration3( String data_structure ) {
