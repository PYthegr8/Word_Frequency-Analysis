...
public class WordCounterExploration2 {
	...
	public static void main( String[] args ) {
		// Exploration2
			...
			WordCounterExploration2 wcReddit = new WordCounterExploration2("HashMap");
			ArrayList<String> wordsReddit = wcReddit.readWords(filenameReddit);
		

			for (int i=0 ; i<5; ++i){	
				System.out.println("Trial "+ i + ": Time taken in ms HashMap Reddit   ----" + wcReddit.buildMap(wordsReddit));
			}
			...
			WordCounterExploration2 wcShakespeare = new WordCounterExploration2("HashMap");
			...
			WordCounterExploration2 wcReddit2 = new WordCounterExploration2("BST");
			ArrayList<String> wordsReddit2 = wcReddit2.readWords(filenameReddit2);


			for (int i=0 ; i<5; ++i){	
				System.out.println("Trial "+ i + ": Time taken in ms BST Reddit   ----" + wcReddit2.buildMap(wordsReddit2));
			}
			...
			WordCounterExploration2 wcShakespeare2 = new WordCounterExploration2("BST");
			ArrayList<String> wordsShakespeare2 = wcShakespeare2.readWords(filenameShakespeare2);
			// wcShakespeare.buildMap(wordsShakespeare);
		
			for (int i=0 ; i<5; ++i){	
				System.out.println("Trial "+ i + ": Time taken in ms BST Shakespeare  ----" + wcShakespeare2.buildMap(wordsShakespeare2));
			}
	...
	public WordCounterExploration2( String data_structure ) {
