...
Project 6
Description: This class is HashMap that maps a set of keys to specific values. This extension implements a unique hashfunction.
...
public class HashMapHashFunc<K, V> implements MapSet<K, V> {
    ...
    // implemented a new hashfunction
