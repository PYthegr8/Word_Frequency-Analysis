...
public class WordCounter {
	...
	public WordCounter( String data_structure ) {
		...
		else if (data_structure.equalsIgnoreCase("redblacktree")){
            wordCounts = new RedBlackTree<String, Integer>();
           
        } 
		else if( data_structure.equalsIgnoreCase("ArrayListMap")) {
			wordCounts = new ArrayListMap<String, Integer>();
		}
		else if( data_structure.equalsIgnoreCase("HashMapHashFunc")) {
			wordCounts = new HashMapHashFunc<String, Integer>();
		}
	...
	public static void main( String[] args ) {
		...
		String filename = "CLEANED_shakespeare.txt" ;

		//Use the BST or HashMap
		WordCounter wc = new WordCounter( "HashMapHashFun" ) ;
